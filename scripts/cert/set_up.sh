...
${SCRIPT_DIR}/tls_db.sh ${CERTIFICATE_AUTHORITY_PATH}
${SCRIPT_DIR}/tls_users.sh ${CERTIFICATE_AUTHORITY_PATH}
${SCRIPT_DIR}/tls_frontend.sh ${CERTIFICATE_AUTHORITY_PATH}
